...
\input{report/Tabs/good_taste_summary_table.tex}
\input{report/Tabs/good_taste_def_examples_table.tex}
\input{report/Tabs/good_taste_ex_examples_table.tex}
...
\input{report/Tabs/bad_taste_summary_table.tex}
\input{report/Tabs/bad_taste_def_examples_table.tex}
\input{report/Tabs/bad_taste_ex_examples_table.tex}
...
\begin{figure}[htpb]
    ...
    \includegraphics[width=0.48\textwidth]{report/Plots/schema_corr_Good_Ex_Bad_Ex.png}
    \caption{Pearson Residuals of Schema Correlation for Definitions (Left) and Examples (Right)}
    \label{fig:schema_corr_main}
\end{figure}

\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.48\textwidth]{report/Plots/schema_corr_Good_Def_Good_Ex.png}
    \includegraphics[width=0.48\textwidth]{report/Plots/schema_corr_Bad_Def_Bad_Ex.png}
    \caption{Pearson Residuals of Schema Correlation Between Definitions and Examples}
    \label{fig:schema_corr_cross}
\end{figure}

\subsection{Demographics}

To examine whether cultural taste schemas are patterned by socio-demographic factors, I fit multinomial logistic regression models predicting respondents' primary topic schema (across all four models) using their Age, Gender, Education, and Political Orientation. The Wald $\chi^2$ tests are presented below.

\input{report/Tabs/wald_four_models.tex}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{report/Plots/pca_domain_variables.png}
    \caption{Correlation Circle of Distinction Domains with Principal Components}
    \label{fig:pca_vars}
\end{figure}
...
\input{report/Tabs/anova_pca.tex}
...
\input{report/Tabs/anova_distinction.tex}

\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{report/Plots/distinction_domains.png}
    \caption{Average Distinction Rating by Domain and Good Taste Schema (Definitions)}
...
\begin{figure}[htpb]
    ...
    \caption{Average Distinction Rating by Domain and Bad Taste Schema (Definitions)}
    \label{fig:distinction_bad_def}
\end{figure}

\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{report/Plots/distinction_domains_good_ex.png}
    \caption{Average Distinction Rating by Domain and Good Taste Schema (Examples)}
    \label{fig:distinction_good_ex}
\end{figure}

\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{report/Plots/distinction_domains_bad_ex.png}
    \caption{Average Distinction Rating by Domain and Bad Taste Schema (Examples)}
    \label{fig:distinction_bad_ex}
\end{figure}
